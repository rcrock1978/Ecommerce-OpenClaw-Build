...
export class InventoryModel {
  ...
  async findByProduct(productId: string, variantId?: string): Promise<InventoryItem | null> {
    const result = await this.pool.query(`
  ...
  async reserveStock(inventoryId: string, quantity: number, movement: InventoryMovement): Promise<void> {
  ...
  async releaseStock(inventoryId: string, quantity: number, movement: InventoryMovement): Promise<void> {
    const client = await this.pool.connect();
  ...
  async adjustStock(inventoryId: string, quantity: number, movement: InventoryMovement): Promise<void> {
    const client = await this.pool.connect();
  ...
  async createAlert(alert: StockAlert): Promise<void> {
  ...
  async getAlerts(acknowledged = false): Promise<StockAlert[]> {
    const result = await this.pool.query(`
